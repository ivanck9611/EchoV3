...
echo "<td> <strong>Cart Id  <td> <strong> Image <td> <strong> Quantity <td><strong>Price<td> <strong> <strong>Sub Total </td> <tr>";

while($rows = mysqli_fetch_row($r))
{

	echo "<td align = 'center'> ".$rows[0];
	echo "<td align = 'center'><img src = '".$rows[5]."' height = 120 width = 120>";
